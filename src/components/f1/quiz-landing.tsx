    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-2xl flex-col items-center text-center">
        ...
        >
          ...
          wrong. Answer honestly and we'll match you against sixteen of the greatest to ever drive,
          from Lauda and Senna to Verstappen and Piastri.
        </p>
